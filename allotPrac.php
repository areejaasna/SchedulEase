...
<div align="center">
    <form action="allotPracValid.php" method="post" style="margin-top: 100px">
    ...
    <div style="margin-top: 5px">
            <select name="tobealloted" class="list-group-item">
                ...
                "SELECT * FROM subjects WHERE subject_type = 'practical'");
                $row_count = mysqli_num_rows($q);
                if ($row_count) {
                    $mystring = '
         <option selected disabled>Select Paper</option>';
                    while ($row = mysqli_fetch_assoc($q)) {
                        if ($row['isAlloted'] == 1 || $row['subject_type'] == "tutorial" || $row['subject_type'] == "na")
                            continue;
...
<br>
    ...
    <div align="center">
       <caption><strong>PRACTICAL PAPER ALLOTMENT</strong></caption>
    </div>
    ...
    while ($row = mysqli_fetch_assoc($q)) {
        ...
        if ($row['isAlloted'] == 0 || $row['subject_type'] == 'tutorial' || $row['subject_type'] == 'na')
            continue;
