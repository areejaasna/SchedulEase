...
<div class="collapse navbar-collapse" id="menu">
    ...
    <li class="nav-item ">
      ...
      <li class="nav-item">
        <a class="nav-link"class="color-me"  href="addsubject.php">Subject</a>
      </li>
      <!-- <li class="nav-item">
...
<div align="center">
    <form action="allotNaValid.php" method="post" style="margin-top: 100px">
    ...
    <div style="margin-top: 5px">
         ...
         <option selected disabled>Select Paper</option>';
                    while ($row = mysqli_fetch_assoc($q)) {
                        if ($row['isAlloted'] == 1 || $row['subject_type'] == "practical" || $row['subject_type'] == "tutorial")
                            continue;
...
<br>
    ...
    <div align="center">
       <caption><strong>NA PAPER ALLOTMENT</strong></caption>
    </div>
    ...
    while ($row = mysqli_fetch_assoc($q)) {
        if ($row['isAlloted'] == 0 || $row['subject_type'] == 'practical' || $row['subject_type'] == "tutorial")
            continue;
